...
from trustedge_wg.gui.connection_view import ConnectionSnapshot
...
class ConnectionPanel:
    ...
    def _ensure_window(self) -> NSWindow:
        ...
        self._title_field = self._make_label("TrustEdge", bold=True, size=18)
